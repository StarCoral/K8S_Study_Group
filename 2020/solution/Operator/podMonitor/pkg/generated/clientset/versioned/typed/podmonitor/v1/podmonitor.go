...
import (
	...
	scheme "github.com/NTHU-LSALAB/podMonitor/pkg/generated/clientset/versioned/scheme"
...
type PodMonitorInterface interface {
	...
	UpdateStatus(*v1.PodMonitor) (*v1.PodMonitor, error)
...
func newPodMonitors(c *LsalabV1Client, namespace string) *podMonitors {
	return &podMonitors{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *podMonitors) UpdateStatus(podMonitor *v1.PodMonitor) (result *v1.PodMonitor, err error) {
	result = &v1.PodMonitor{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("podmonitors").
