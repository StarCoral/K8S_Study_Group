...
import (
	...
	internalinterfaces "github.com/NTHU-LSALAB/podMonitor/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/NTHU-LSALAB/podMonitor/pkg/generated/listers/podmonitor/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.LsalabV1().PodMonitors(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LsalabV1().PodMonitors(namespace).Watch(options)
			},
		},
		&podmonitorv1.PodMonitor{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *podMonitorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&podmonitorv1.PodMonitor{}, f.defaultInformer)
}
